...
const SearchBox = () => {
    ...
    return (
        <View className="w-full flex flex-row items-center p-3 bg-gray-200 rounded-lg">
            ...
            <TextInput value={searchQuery.query} onChangeText={setSearchText} autoCorrect={true} placeholderTextColor="#999" keyboardAppearance='dark' autoFocus className="flex-1 text-gray-500 ml-3 text-base" placeholder='Search...' />
